...
const PhoneInput: React.FC<PhoneInputProps> = ({ 
  ...
  const numberValue = value && isValidPhoneNumber(value) && value.startsWith(selectedCountry.phoneCode)
  ...
  return (
    <div className={`space-y-2.5 ${className}`}>
      <label className="block text-[#CDCDCD] text-[13.41px]/[15.07px] text-normal">
        {label}
      </label>
      <div className="flex relative">
        ...
        <Dropdown isOpen={isOpen} onClose={() => setIsOpen(false)}>
          <div className="absolute z-50 w-[260px] max-h-[280px] overflow-y-auto bg-[#303030] border border-[#2F2F2F] rounded-lg shadow-lg">
            <div className="p-2">
              <div className="flex justify-between items-center text-xs px-3 py-2 font-medium text-white bg-[#303030] border-b border-[#2F2F2F]">
                <span>Choose your country code</span><ChevronDownIcon />
              </div>
