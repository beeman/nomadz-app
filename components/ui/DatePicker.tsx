...
const DatePickerWithRange: React.FC<DatePickerWithRangeProps> = ({ onChange, value, className, buttonClassName = '', dropdownClassName = 'max-lg:left-1/2 max-lg:-translate-x-1/2', monthsShown = 2, icon, zIndex, ...props }) => {
  ...
  const getButtonLabel = (date: Date | null) => {
    ...
    return value.range === 'exact' 
      ...
      : `${date.toLocaleDateString()} ${value.range}`;
  };
  ...
  return (
    <div className={`relative flex justify-center items-center ${className || ''}`}>
      ...
      <div className="!w-[1px] !h-[38px] bg-[#4A4A4A]"/>
      ...
      <Dropdown
        ...
        zIndex={zIndex}
      >
        <div className="bg-[#1B1B1B] rounded-2xl p-6 space-y-4">
          <ReactDatePicker
          ...
          <div className='h-[1px] bg-[#4E4E4E] !-mt-2'></div>

          <div className="flex gap-2 overflow-x-auto no-scrollbar max-lg:max-w-[236px] lg:max-w-[474px] lg:w-max">
