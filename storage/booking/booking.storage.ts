...
import { accomplishQuestAtom, fetchQuestByTagAtom, userQuestsAtom } from '../quests.storage'
...
export const bookingErrorsAtom = atom<any>({
  preBook: null,
  initialize: null,
  finish: null,
  cancel: null,
...
export const initializeBookingAtom = atom(null, async (get, set, { hid, hash }: { hid: number; hash: string }) => {
...
export const cancelBookingAtom = atom(null, async (get, set, orderId: string) => {
