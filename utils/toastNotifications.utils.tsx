...
export function CustomToast({ type, title, message, closeToast }: CustomToastProps) {
...
const toastNotifications = {
  success: (title: string, details: string = '') => {
    toast(<CustomToast type="success" title={title} message={details} />, {
      closeButton: false,
      autoClose: 2500,
  ...
  error: (title: string, details: string = '') => {
    toast(<CustomToast type="error" title={title} message={details} />, {
      closeButton: false,
      autoClose: 5000,
      hideProgressBar: true,
    })
  ...
  info: (title: string, details: string = '') => {
    toast(<CustomToast type="info" title={title} message={details} />, {
      closeButton: false,
      autoClose: 2500,
      hideProgressBar: true,
    })
